...
export interface PluginApiFormsForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::api-forms.form"> & Schema.Attribute.Private;
    notifications: Schema.Attribute.Relation<"oneToMany", "plugin::api-forms.notification">;
    publishedAt: Schema.Attribute.DateTime;
    steps: Schema.Attribute.JSON;
    submissions: Schema.Attribute.Relation<"oneToMany", "plugin::api-forms.submission">;
...
export interface PluginApiFormsNotification extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::api-forms.notification"> & Schema.Attribute.Private;
    message: Schema.Attribute.Text & Schema.Attribute.DefaultTo<"">;
    publishedAt: Schema.Attribute.DateTime;
    service: Schema.Attribute.String & Schema.Attribute.DefaultTo<"emailService">;
    subject: Schema.Attribute.String;
...
export interface PluginApiFormsSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::api-forms.setting"> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
...
export interface PluginApiFormsSubmission extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    form: Schema.Attribute.Relation<"manyToOne", "plugin::api-forms.form">;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::api-forms.submission"> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
